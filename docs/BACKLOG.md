...
- [x] **1.1 — Paste → clustered, labeled 2D map (THE WOW MOMENT)**
...
- [x] **1.2 — On-device embedding with visible model-download progress**
...
- [x] **1.3 — Constellation-forming "snap" animation + cluster lines**
...
- [x] **1.4 — Design polish: execute the celestial theme on the map**
...
- [x] **2.1 — Hover a point to read its line**
...
- [x] **2.2 — Cluster legend with names and sizes**
...
- [x] **2.3 — Cluster-count slider re-clusters live**
...
- [x] **2.5 — Design polish: interaction states + juice + SFX**
...
- [x] **3.1 — One-click sample datasets**
...
- [x] **3.2 — Export the clustered result**
...
- [x] **3.3 — Designed empty, loading, error states + input validation**
...
- [x] **3.4 — Landing page (`site/`) sharing the app brand**
